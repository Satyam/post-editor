...
export const plugin_dialog = {
  ...
  setDialog: function (core) {
    ...
    // dialog.appendChild(
    //   document.getElementById('linkDialog').content.cloneNode()
    // );
    return dialog;
  },
  ...
  setController_LinkButton: function (core) {
    ...
    // link_btn.appendChild(
    //   document.getElementById('linkController').content.cloneNode()
    // );
    link_btn.innerHTML = `
